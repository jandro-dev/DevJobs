		...
		<section className={styles.section}>
			...
			<div
				...
				dangerouslySetInnerHTML={{	
					__html: html, // Injeccion de html con markdown
				}}
			/>
		</section>
	);
...
export default function JobDetail() {
	...
	if (loading) {
		return (
			<div style={{ masWidth: "1280px", margin: "0 auto", padding: "0 1rem" }}>
	...
	// Lo que renderiza si hay un error o no encuentra la oferta
	if (error || !job) {
		return (
	...
	// Lo que renderiza si todo va bien
	return (
		<div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 1rem" }}>
